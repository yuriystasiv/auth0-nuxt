// Mirrored by `../route-rule-types-nuxt3/nuxt.config.ts` for Nuxt 3. Keep the two in step: the
// only intended difference between the fixtures is which `nuxt` their root directory resolves.
